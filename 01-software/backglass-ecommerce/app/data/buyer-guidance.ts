...
export const buyerGuidance: Record<string, GuidancePage> = {
  ...
  "premium-plus-camera-lens": {
    ...
    sections: [
      { question: "Which models can be ordered as Premium Plus?", answer: `Premium Plus is listed only for ${premiumPlusModelList}. No other model, and no generation outside iPhone 15 to iPhone 17, is offered as Premium Plus. The whole iPhone 14 series is Glass Only in this catalog, so no iPhone 14 model is offered as Premium Plus.` },
