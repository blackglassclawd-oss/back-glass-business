/* eslint-disable */
// Generated by Wrangler by running `wrangler types --config=wrangler.shopify-passthrough.jsonc --env=production --env-file=.passthrough.env --env-interface=PassthroughEnv worker-passthrough-configuration.d.ts` (hash: a89ba08a7f2f468f5cc160cf70787e55)
// Runtime types generated with workerd@1.20260722.1 2026-08-09 nodejs_compat
interface __BaseEnv_PassthroughEnv {
}
declare namespace Cloudflare {
	interface GlobalProps {
		mainModule: typeof import("./workers/shopify-passthrough");
	}
	interface Env extends __BaseEnv_PassthroughEnv {}
}
interface PassthroughEnv extends __BaseEnv_PassthroughEnv {}
